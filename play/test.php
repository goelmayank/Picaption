...
<head>
	...
	<body>
		...
		<nav class="thumb-nav">
			<a data-container="container-1" class="thumb-nav__item" href="http://localhost/picaption/play/caption.php"><img src="img/thumbs/1.jpg" alt="Img1" width="50" height="50" /></a>
				...
				<div class="intro__content">
					<div class="intro__subtitle">
						<form class="captionForm" id="form5" method="post" action="game.php">
							...
							<input type="submit" name="final_submit" class="captify" value="Final Submit!"/>
						</form>
						<button class="trigger">
							<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="none">
								<use class="icon icon--grid" xlink:href="#icon-grid" />
